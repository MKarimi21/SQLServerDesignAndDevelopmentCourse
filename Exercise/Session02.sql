...
ALTER TABLE TBL03 ADD NATIONALCODE CHAR(10);
GO

-- DML: Data Manipulation Language
INSERT INTO dbo.TBL03
(FIRSTNAME, LASTNAME, NATIONALCODE)
VALUES
('Mostafa', 'Karimi', '0670546747');

SELECT * FROM dbo.TBL03;

UPDATE dbo.TBL03
SET NATIONALCODE = '1234567890'
WHERE NATIONALCODE = '0670546747';

DELETE dbo.TBL03 WHERE NATIONALCODE = '1234567890';